    ...
    for line in split {
        ...
        for subset in subsets {
            ...
            for cube in cubes {
                ...
                match split_cube[1] {
                    "red" => if amount > fewest_red { fewest_red = amount; },
                    "green" => if amount > fewest_green { fewest_green = amount; },
                    "blue" => if amount > fewest_blue { fewest_blue = amount; },
                    _ => panic!(),
                }
            }
        }
        // if fewest_red == f64::INFINITY { fewest_red = 1 }

        sum += fewest_red * fewest_green * fewest_blue;
